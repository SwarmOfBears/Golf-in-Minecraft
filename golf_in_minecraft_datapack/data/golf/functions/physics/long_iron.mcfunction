# Motion
playsound golf:swing_2 player @a ~ ~ ~ 3 1

execute store result score @s golf.motionX1 run data get entity @s Pos[0] 2000
execute store result score @s golf.motionY1 run data get entity @s Pos[1] 2000
execute store result score @s golf.motionZ1 run data get entity @s Pos[2] 2000

execute store result score @s golf.motionX2 run data get entity @p Pos[0] 2000
execute store result score @s golf.motionY2 run data get entity @p Pos[1] 2000
execute store result score @s golf.motionZ2 run data get entity @p Pos[2] 2000
...
# Iron y-lift
scoreboard players add @s golf.motionY3 800
...
execute store result entity @s Motion[0] double -0.0015 run scoreboard players get @s golf.motionX3
execute store result entity @s Motion[1] double 0.00075 run scoreboard players get @s golf.motionY3
execute store result entity @s Motion[2] double -0.0015 run scoreboard players get @s golf.motionZ3
