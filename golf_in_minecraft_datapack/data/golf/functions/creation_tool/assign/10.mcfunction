...
execute as @e[type=interaction,tag=golfTee,limit=1,sort=nearest,distance=..10] run scoreboard players set @s golf.currentHole 10
execute at @e[type=interaction,tag=golfTee,limit=1,sort=nearest,distance=..10] run tellraw @s {"text":"[Golf] Assigned Hole 10 to a nearby Tee-Box.","color":"gold"}
...
execute unless score #golf.assigned golf.bool matches 1 as @e[type=armor_stand,tag=golfHole,limit=1,sort=nearest,distance=..10] run scoreboard players set @s golf.currentHole 10
execute unless score #golf.assigned golf.bool matches 1 at @e[type=armor_stand,tag=golfHole,limit=1,sort=nearest,distance=..10] run tellraw @s {"text":"[Golf] Assigned Hole 10 to a nearby Flag Pole.","color":"gold"}
